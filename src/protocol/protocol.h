...
typedef enum {
    ...
    JOIN_ROOM, JOIN_ROOM_SUCCESS, JOIN_ROOM_FAILURE, ROOM_NOT_FOUND, ROOM_FULL, GAME_ALREADY_STARTED, PLAYER_JOINED, JOIN_RANDOM, START_GAME, START_GAME_FAILURE,START_GAME_SUCCESS,
    ROOM_LIST,
    ROOM_JOINED,
    GAME_START,
    GAME_STATUS,
